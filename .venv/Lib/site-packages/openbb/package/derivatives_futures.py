...
class ROUTER_derivatives_futures(Container):
    ...
    def curve(
        ...
        provider: Annotated[Optional[Literal['deribit', 'yfinance']], OpenBBField(description='The provider to use, by default None. If None, the priority list configured in the settings is used. Default priority: deribit, yfinance.')] = None,
        **kwargs
    ) -> OBBject:
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'symbol': {'deribit': {'multiple_items_allowed': False, 'choices': ['BTC', 'ETH', 'PAXG']}}, 'date': {'yfinance': {'multiple_items_allowed': True, 'choices': None}}, 'hours_ago': {'deribit': {'multiple_items_allowed': True, 'choices': None}}},
            )
        )
    ...
    def historical(
        self,
        symbol: Annotated[Union[str, list[str]], OpenBBField(description='Symbol to get data for. Multiple comma separated items allowed for provider(s): deribit, yfinance.')],
        ...
        **kwargs
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'symbol': {'deribit': {'multiple_items_allowed': True, 'choices': None}, 'yfinance': {'multiple_items_allowed': True, 'choices': None}}, 'interval': {'deribit': {'multiple_items_allowed': False, 'choices': ['1m', '3m', '5m', '10m', '15m', '30m', '1h', '2h', '3h', '6h', '12h', '1d']}}},
            )
        )
    ...
    def info(
        self,
        provider: Annotated[Optional[Literal['deribit']], OpenBBField(description='The provider to use, by default None. If None, the priority list configured in the settings is used. Default priority: deribit.')] = None,
        **kwargs
    ) -> OBBject:
