...
class ROUTER_derivatives_options(Container):
    ...
    def chains(
        ...
        provider: Annotated[Optional[Literal['deribit', 'intrinio', 'yfinance']], OpenBBField(description='The provider to use, by default None. If None, the priority list configured in the settings is used. Default priority: deribit, intrinio, yfinance.')] = None,
        **kwargs
    ) -> OBBject:
        ...
        ----------
        provider : str
            The provider to use, by default None. If None, the priority list configured in the settings is used. Default priority: deribit, intrinio, yfinance.
        symbol : str
    ...
    def surface(
        self,
        data: Annotated[Union[list, dict, DataFrame, list['DataFrame'], Series, list['Series'], ndarray, Data, list[Data], Data], OpenBBField(description='')],
        ...
        option_type: Annotated[Optional[Literal['otm', 'itm', 'calls', 'puts']], OpenBBField(description='')] = 'otm',
